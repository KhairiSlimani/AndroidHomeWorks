...
class ExperienceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ExperienceList.add(Experiences(ExpPic = R.drawable.ic_logo_harvard,ExpName = "HARVARD",ExpLoc = "United States",ExpFirstDate = "01/09/2019",ExpLastDate = "TODAY",ExpDesc = "Harvard"))
